...
Class Dte
{
    ...
    private function generarXML($venta, $detalle)
    {
        try {
            ...
            $xml->text("COMPAÑIA DE AGUA DE LAS TERRAZAS, S.A.");
            $xml->startAttribute("CodigoEstablecimiento");
            $xml->text("1");
            $xml->startAttribute("NombreComercial");
            $xml->text("COMPAÑIA DE AGUA DE LAS TERRAZAS");
            ...
            $xml->writeElementNs($prefix, 'Direccion', null, "Colonia los conacastes, zona 0");
